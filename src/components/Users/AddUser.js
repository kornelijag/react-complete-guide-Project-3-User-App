...
const AddUser = (props) => {
  ...
  /*
  There is no need to pass an initial value to the error State because
  if it's empty, it means there is no error. 
  The value is then 'undefined', which is a valid value type in JS.
  */
